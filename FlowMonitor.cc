...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE ("FlowMon");
int main (int argc, char *argv[])
{
 ...
 ApplicationContainer apps = server1.Install (nodes.Get (1));
 ...
 p2p.EnablePcap("FlowMon", dev, false);
 ...
 std::cout<<" t.sourceAddress="<<t.sourceAddress<<"t.destinationAddress="<<t.destinationAddress<<" Source port:"<<t.sourcePort<<" "
